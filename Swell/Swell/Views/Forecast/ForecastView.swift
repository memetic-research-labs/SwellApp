...
struct ForecastView: View {
    ...
    private func windColor(_ windScore: Double) -> Color {
...
struct CompactRow: View {
    ...
    var windBadgeColor: Color {
        if score.windScore > 0.6 { return .green }
        if score.windScore > 0.3 { return .yellow }
        return .red
    }
